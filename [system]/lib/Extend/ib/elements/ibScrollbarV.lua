...
_IB_STYLES[ E_CLASS ] = {
    ...
    ganzes = {
        ...
        bg_texture = ':nrp_shared/img/rt/scroll_bg.png',
        bg_px = 0, bg_py = 0, bg_sx = 5,
        --bg_color =,

        handle_texture = ':nrp_shared/img/rt/scroll.png',
        handle_px = 0,
        handle_py = 0,
        handle_sy = 82,
        handle_sx = 5, handle_lower_limit = 0, handle_upper_limit = -80,
    }
}
