...
addEventHandler("onClientResourceStart",getResourceRootElement(getThisResource()),function()
	...
	snow.window = guiCreateWindow(sx-290,sy-345,285,340,"Настройки снега",false)
	...
	snow.wind_direction_label = guiCreateLabel(13,117,123,19,"Направление ветра:",false,snow.window)
	...
	snow.snow_type_label = guiCreateLabel(13,23,109,19,"Тип снега:",false,snow.window)
	guiLabelSetColor(snow.snow_type_label,255,255,255)
	guiSetFont(snow.snow_type_label,"default-bold-small")	
	snow.snow_type_real = guiCreateRadioButton(14,41,90,23,"Реальный",false,snow.window)
	snow.snow_type_cartoon = guiCreateRadioButton(105,41,90,23,"Мультфильм",false,snow.window)
	...
	snow.snow_density_label = guiCreateLabel(13,69,107,20,"Плотность снега:",false,snow.window)
...
--	snow.snow_density_scrollbar = guiCreateScrollBar(11,88,193,20,true,false,snow.window)
	...
	snow.wind_speed_label = guiCreateLabel(13,218,123,20,"Скорость ветра:",false,snow.window)
	...
	snow.snowflake_size_label = guiCreateLabel(162,69,107,20,"Размер снежинок:",false,snow.window)
	...
	snow.fall_speed_label = guiCreateLabel(13,265,135,20,"Скорость падения снега:",false,snow.window)
	...
	snow.jitter_label = guiCreateLabel(195,117,80,19,"Дрожание:",false,snow.window)
	guiLabelSetHorizontalAlign(snow.jitter_label,"right")
	guiSetFont(snow.jitter_label,"default-bold-small")
	snow.jitter_yes = guiCreateRadioButton(5,5,50,20,"Да",false,snow.jitter_backing)
	snow.jitter_no = guiCreateRadioButton(5,30,50,20,"Нет",false,snow.jitter_backing)
	guiRadioButtonSetSelected(snow.jitter_yes,settings.jitter)	
	guiRadioButtonSetSelected(snow.jitter_no,not settings.jitter)	
	
	snow.accept_button = guiCreateButton(16,312,84,22,"Применить",false,snow.window)
	snow.exit_button = guiCreateButton(184,312,84,22,"Закрыть",false,snow.window)
...
function toggleSnow()
	guiSetVisible(snow.window, not guiGetVisible(snow.window))
	showCursor(guiGetVisible(snow.window))
