...
function enableGoundSnow()
	...
	snowShader = dxCreateShader ( "files/snow_ground.fx", 0, maxEffectDistance )
	treeShader = dxCreateShader( "files/snow_trees.fx" )
	naughtyTreeShader = dxCreateShader( "files/snow_naughty_trees.fx" )
