...
float4 PixelShaderFunction(PSInput PS) : COLOR0
{
    ...
    if(vColor.a){
        ...
        // fColor = 0;
        fColor = fColor*vColor.a;

        float4 Color = 1;
        finalColor = envMap * fEnvContribution;
        finalColor.a = 1.0;
        Color = (finalColor - paintColor) / 2;
        Color.rgb += PS.Specular.rgb*2;
        Color.a = PS.Diffuse.a;

        fColor += cColor*(1-vColor.a);
        fColor += Color*vColor.a;
    ...
    if(temp_vColor.a){
        ...
        fColor += cColor*(1-temp_vColor.a);
        fColor += Color*temp_vColor.a;
