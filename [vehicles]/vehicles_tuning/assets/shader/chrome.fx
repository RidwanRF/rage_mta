...
PSInput VertexShaderFunction(VSInput VS)
{
    ...
    PS.Specular.rgb = gMaterialSpecular.rgb * MTACalculateSpecular( 5 * gCameraDirection, gLightDirection *5,
        PS.Normal, gMaterialSpecPower ) * specularValue;

    PS.Specular *= specularColor / 12000;
...
float4 PixelShaderFunction(PSInput PS) : COLOR0
{
    ...
    float brightnessFactor = 0.4; // the default value is 0.10
    ...
    float4 envMap = texCUBE( ReflectionSampler, -vReflection )*1.5;
