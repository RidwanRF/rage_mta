guiLanguage.russian = {
    ...
    -- GENERAL STRINGS
    --
    windowHeader = "Редактор Хэндлинга",
    ...
    -- needAdmin = "Только администратор может использовать это меню.", -- ЧЕНДЖ
    needAdmin = "Используйте меню F3 для сброса настроек", -- ЧЕНДЖ
    ...
    notInRepair = "Изменять параметры машины можно только на СТО.", -- ЧЕНДЖ
