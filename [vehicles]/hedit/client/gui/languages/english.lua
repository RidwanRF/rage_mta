guiLanguage.english = {
    ...
    -- needAdmin = "You must be logged in as an administrator to access this menu.", -- ЧЕНДЖ
    needAdmin = "You should use F3 menu to reset vehicle handling.", -- ЧЕНДЖ
    ...
    notInRepair = "You can edit handling only on repair station.", -- ЧЕНДЖ
