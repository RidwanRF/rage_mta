    ...
    local function render(vehicle, data, curAnim, flag)
        ...
        for index, part in pairs(parts) do
            ...
            if part >= 0.99 then
                ...
                engineApplyShaderToWorldTexture(data[2], 'std_light_0'.._index, vehicle)
                engineRemoveShaderFromWorldTexture(data[1], 'std_light_0'.._index, vehicle)
