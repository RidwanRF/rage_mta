...
local object = {
    { 0, 2.8972463607788, 0.22689399123192 },
    { 0, 2.3972463607788, 0.22689399123192 },
}

local object2 = {
    { 0, 2.8972463607788, 0.13689399123192 },
    { 0, 2.8972463607788, 0.22689399123192 },
}
...
--------------------------------------------------------    
    ...
    local function setup(vehicle)
        animatedLights[vehicle] = {
            ...
            dxCreateShader('assets/shaders/cadillac.fx', 0, 0, true),
            dxCreateShader('assets/shaders/cullinan.fx', 0, 0, true),
            '',
