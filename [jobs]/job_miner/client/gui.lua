		...
		{'image',
			...
			onRender = {
				...
				function(element)
					...
					dxDrawImage(
						x + 35, y + 25, 38, 38, 'assets/images/miner.png',
					...
					dxDrawText('Добывай руду, переноси ее\nна переплавку и получай за это деньги',
						x, y + 100,
						x+w, y + 100,
						tocolor(255,255,255,255*alpha),
				...
				{'button',
					...
					onClick = function(element)
						...
						displayLoading( {x+w/2-40/2, y+h/2-40/2, 40, 40}, {180,70,70,255}, 800, function()
							...
							triggerServerEvent('miner.start', resourceRoot,
								currentStationId
							)
				...
				{'element',
					...
					onRender = function(element)
						...
						local rows = {
							...
							{ name = 'Перенесено руды', value = (stats.orders_passed or 0) },
							{ name = 'Заработано за сессию', value = string.format('$%s', splitWithPoints(
								localPlayer:getData('job.session_stats.job_miner.raised_money') or 0, '.' )) },
						}
