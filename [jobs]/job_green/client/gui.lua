		...
		{'image',
			...
			onRender = {
				...
				function(element)
					...
					dxDrawImage(
						x + 35 + 38/2 - 56/2, y + 25 + 38/2 - 56/2, 56, 56, 'assets/images/green.png',
						0, 0, 0, tocolor(40, 40, 40, 255*alpha)
					)

					dxDrawText('Газонокосильщик',
						x + 35 + 38 + 15, y + 25,
						x + 35 + 38 + 15, y + 25 + 38,
					...
					dxDrawText('Коси газоны и получай за это деньги\nЧтобы активировать лезвие, зажми ПКМ',
						x, y + 100,
						x+w, y + 100,
						tocolor(255,255,255,255*alpha),
				...
				{'button',
					...
					onClick = function(element)
						...
						displayLoading( {x+w/2-40/2, y+h/2-40/2, 40, 40}, {180,70,70,255}, 800, function()
							...
							triggerServerEvent('green.start', resourceRoot,
								currentStationId
							)
				...
				{'element',
					...
					onRender = function(element)
						...
						local rows = {
							...
							{ name = 'Всего скошено травы', value = (stats.markers_passed or 0) .. 'м²' },
							{ name = 'Заработано за сессию', value = string.format('$%s', splitWithPoints(
								localPlayer:getData('job.session_stats.job_green.raised_money') or 0, '.' )) },
						}
